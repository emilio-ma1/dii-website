// src/tests/models/professorModel.test.js
...
describe('professorModel', () => {
  ...
  describe('getAll', () => {
    ...
    it.todo('02 - Ejecuta la consulta con joins de users, professors, project_authors y projects')
    it.todo('03 - Filtra por u.role = teacher')
    it.todo('04 - Retorna rows cuando la consulta es exitosa')
    it.todo('05 - Retorna arreglo vacío si no hay docentes')
    it.todo('06 - Hace console.error y relanza error si la consulta falla')
  })

  describe('upsert', () => {
    it.todo('07 - Llama pool.query con INSERT INTO professors')
  ...
  describe('delete', () => {
    it.todo('13 - Llama pool.query con DELETE FROM professors WHERE user_id = $1')
