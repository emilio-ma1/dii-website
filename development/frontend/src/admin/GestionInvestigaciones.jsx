...
const INITIAL_PROJECTS = [
  {
    ...
    description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.",
 ...
 * Si no se proporciona una URL, se usa la imagen por defecto.
 *
...
/**
 * Componente principal para la gestión de investigaciones.
 ...
 *
 * @returns {JSX.Element} Vista principal de gestión de investigaciones.
 * @throws {Error} Este componente no lanza excepciones controladas.
 */
