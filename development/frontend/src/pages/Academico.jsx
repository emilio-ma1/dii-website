    ...
    <div className="bg-gray-100 min-h-screen pt-12 pb-12 px-4">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-6">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#610b2f]">
            ACADÉMICO
          </h1>
        ...
        <div className="space-y-16 max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <Link to="/industrial" className="block">
              <div className="group cursor-pointer relative bg-gradient-to-br from-[#6b133b] to-[#610b2f] rounded-3xl p-8 lg:p-12 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 border-4 border-white/20 h-[22rem] lg:h-[26rem]">
                <div className="flex items-center h-full gap-8">
                  {/* logo civil industrual */}
                  <div className="w-48 h-48 lg:w-56 lg:h-56 bg-white/95 rounded-2xl flex items-center justify-center shadow-2xl border-4 border-white/80 p-4 lg:p-6 group-hover:scale-105 transition-all shrink-0">
                    <img
                  ...
                  <div className="flex-1 bg-white/90 backdrop-blur-md rounded-2xl p-6 lg:p-8 shadow-xl border border-white/60 h-full flex flex-col justify-center">
                    <h3 className="text-xl lg:text-2xl font-semibold text-[#610b2f] mb-3">
                      Resumen Carrera
                    </h3>
